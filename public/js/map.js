      ...
      success: function(data) {
        if (data.length > 0) {
          ...
          // HTML template for the slides
            template = "<div class='carousel-inner'>{{#pictures}}<div class='item' id='{{id}}'><img src='/images/main/{{id}}.jpg'><div class='carousel-caption'><h4>{{title}}</h4></div></div>{{/pictures}} </div><a class='carousel-control left' href='#myCarousel' data-slide='prev'>&lsaquo;</a><a class='carousel-control right' href='#myCarousel' data-slide='next'>&rsaquo;</a>",
...
$('#map').css('width', $('body').width()-$('body').width()*0.03);
